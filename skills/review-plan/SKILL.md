...
1. Read applicable `AGENTS.md`, plan, and only files needed to verify it.
...
3. Fix every evidenced failure. Preserve valid scope and decisions. Make smallest correct plan.
4. Update plan file in place when one exists. Otherwise return full corrected plan.
5. Report key fixes and remaining user decisions. Stop. Do not edit implementation files, spawn agents, commit, push, or open PRs.
