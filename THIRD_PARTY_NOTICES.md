...
This repository contains material from the following projects. The Apache-2.0 license for the collection does not replace the licenses that apply to these files.

## openai/skills

- Source: https://github.com/openai/skills
- Included skill: `define-goal`
- Source commit: `49f948faa9258a0c61caceaf225e179651397431`
- License: Apache License 2.0
- License text: [`define-goal/LICENSE.txt`](define-goal/LICENSE.txt)

## intellectronica/agent-skills

- Source: https://github.com/intellectronica/agent-skills
- Included skill: `context7`
- License: CC0 1.0 Universal
- License text: [`LICENSES/CC0-1.0.txt`](LICENSES/CC0-1.0.txt)
